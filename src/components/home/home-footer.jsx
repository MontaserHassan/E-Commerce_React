    ...
    return (
        ...
        <Fragment>
            ...
            <div className="d-flex w-100 mt-5">
                ...
                <div className="card gradStart text-center h-100 p-4  w-75 h-25">
                ...
                <div className="card text-center gradCenter h-100 p-4  w-75 h-25">
                ...
                <div className="card text-center gradEnd h-100 p-4  w-75 h-25">
